...
object SystemUtil {
    ...
    fun convertManageIapEntityToJson(manage: ManageIapEntity): String {
        val gson = Gson()
        val json = gson.toJson(manage)

        return json
    }

    fun convertJsonToManageIapEntity(json: String): ManageIapEntity {
        val gson = Gson()
        val manage = gson.fromJson(json, ManageIapEntity::class.java)
